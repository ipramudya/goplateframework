...
type iUsecase interface {
	Register(ctx context.Context, na *accountx.NewAccouuntDTO) (*accountx.AccountDTO, error)
	ChangePassword(ctx context.Context, cp *accountx.ChangePasswordDTO, email string) error
	Me(ctx context.Context, accountID uuid.UUID) (*accountx.AccountDTO, error)
}
...
func (con *controller) register(c echo.Context) error {
	dto := new(accountx.NewAccouuntDTO)
...
func (con *controller) changePassword(c echo.Context) error {
	...
	dto := new(accountx.ChangePasswordDTO)
